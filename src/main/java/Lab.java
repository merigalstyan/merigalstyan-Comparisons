...
public class Lab {
     ...
     */
    public boolean isEqual(int a, int b){if (a==b) {
        return true;
    } else {
        return false;
    }
     ...
     */
    public boolean greaterThan(int a, int b){if (a>b) {
        return true;
    } else {
        return false;
     ...
     */
    public boolean lessThan(int a, int b){if(a<b) {
        return true;
    } else {return false;
    }
    };
     ...
     */
    public boolean greaterThanOrEqualTo(int a, int b){if (a>=b) {
        return true;
    }
    else {
        return false;
     ...
     */
    public boolean lessThanOrEqualTo(int a, int b){if (a<=b) {
        return true;
    }
    else {
        return false;
     ...
     */
    public boolean notEqualTo(int a, int b){if (a!=b) {
        return true;
    }
    else {
        return false;
